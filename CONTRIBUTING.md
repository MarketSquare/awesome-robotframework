...
- [Maintainer helper scripts](#maintainer-helper-scripts)
...
Two standalone Python scripts at the repo root help maintainers discover new entries for this list, outside of incoming PRs:
