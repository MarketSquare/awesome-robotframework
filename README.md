...
- [SerialLibrary](https://github.com/reharish/robotframework-pyserial) Serial port interface using pySerial.
- [SerialLibrary](whosaysni/robotframework-seriallibrary) Serial port interface.
...
- [OKW Remote SSH](https://pypi.org/project/robotframework-okw-remote-ssh/) Deterministic remote command execution and SFTP file transfer via SSH with structured verification (stdout, stderr, exit code, duration) and OKW contract matching.
